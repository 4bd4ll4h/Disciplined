...
public class remainderAdapter extends ListAdapter<remainders_table,remainderAdapter.remainderHolder> {
    Context context;
    ...
    private static DiffUtil.ItemCallback<remainders_table> diffCallback=new DiffUtil.ItemCallback<remainders_table>() {
        @Override
        public boolean areItemsTheSame(remainders_table oldItem, remainders_table newItem) {
            return oldItem.getId()==newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(remainders_table oldItem, remainders_table newItem) {
    ...
    public void onBindViewHolder(@NonNull remainderHolder holder, int position) {
        remainders_table remainders_table=getItem(position);
